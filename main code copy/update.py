...
def Search_button():
    ...
    if (len(p)==0):
        ...
        for i in t:
            l1=tkinter.Label(rootS,text="PATIENT ID",fg='blue',bg='azure3')
            dis1=tkinter.Label(rootS,text=i[0])
            l2=tkinter.Label(rootS,text="PATIENT NAME",fg='blue',bg='azure3')
            dis2=tkinter.Label(rootS,text=i[1])
            l3=tkinter.Label(rootS,text="PATIENT SEX",fg='blue',bg='azure3')
            dis3=tkinter.Label(rootS,text=i[2])
            l4=tkinter.Label(rootS,text="PATIENT BLOOD GROUP",fg='blue',bg='azure3')
            dis4=tkinter.Label(rootS,text=i[3])
            l5=tkinter.Label(rootS,text="PATIENT DATE OF BIRTH",fg='blue',bg='azure3')
            dis5=tkinter.Label(rootS,text=i[4])
            l6=tkinter.Label(rootS,text="PATIENT ADDRESS",fg='blue',bg='azure3')
            dis6=tkinter.Label(rootS,text=i[5])
            l7=tkinter.Label(rootS,text="PATIENT DOCTOR/TEAM",fg='blue',bg='azure3')
            dis7=tkinter.Label(rootS,text=i[6])
            l8=tkinter.Label(rootS,text="PATIENT EMAIL",fg='blue',bg='azure3')
            dis8=tkinter.Label(rootS,text=i[7])
            l9=tkinter.Label(rootS,text="PATEINT CONTACT NO",fg='blue',bg='azure3')
            dis9=tkinter.Label(rootS,text=i[8])
            l10=tkinter.Label(rootS,text="PATIENT ALTERNATE CONTACT",fg='blue',bg='azure3')
...
def P_display():
    ...
    rootS.configure(bg='azure3')
    head=tkinter.Label(rootS,text="ENTER PATIENT ID TO SEARCH",fg="red",bg='azure3')
...
def Delete_button():
    ...
    if (len(p)==0):
        ...
        disd1=tkinter.Label(rootD,text="PATIENT RECORD DELETED",fg='green',bg='azure3')
        disd1.pack()
        conn.commit()
...
def D_display():
    ...
    rootD.configure(bg='azure3')
    headD=tkinter.Label(rootD,text="ENTER PATIENT ID TO DELETE",fg="blue",bg='azure3')
...
def P_UPDATE():
    ...
    menubar.add_cascade(label="File", menu=filemenu)
    HEAD=tkinter.Label(rootU,text="ENTER NEW DETAILS TO UPDATE",bg='azure3',fg='white')
    id = tkinter.Label(rootU, text="PATIENT ID",bg='azure3',fg='white')
    pat_ID = tkinter.Entry(rootU)
    name = tkinter.Label(rootU, text="PATIENT NAME",bg='azure3',fg='white')
    pat_name = tkinter.Entry(rootU)
    sex = tkinter.Label(rootU, text="SEX",bg='azure3',fg='white')
    pat_sex = tkinter.Entry(rootU)
    dob = tkinter.Label(rootU, text="DOB (YYYY-MM-DD)",bg='azure3',fg='white')
    pat_dob = tkinter.Entry(rootU)
    bg = tkinter.Label(rootU, text="BLOOD GROUP",bg='azure3',fg='white')
    pat_BG = tkinter.Entry(rootU)
    c1 = tkinter.Label(rootU, text="CONTACT NUMBER",bg='azure3',fg='white')
    pat_contact = tkinter.Entry(rootU)
    c2 = tkinter.Label(rootU, text="ALTERNATE CONTACT",bg='azure3',fg='white')
    pat_contactalt = tkinter.Entry(rootU)
    email = tkinter.Label(rootU, text="EMAIL",bg='azure3',fg='white')
    pat_email = tkinter.Entry(rootU)
    ct = tkinter.Label(rootU, text="CONSULTING TEAM / DOCTOR",bg='azure3',fg='white')
    pat_CT = tkinter.Entry(rootU)
    addr = tkinter.Label(rootU, text="ADDRESS",bg='azure3',fg='white')
