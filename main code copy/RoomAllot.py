...
def update_button():
    ...
    if len(p) != 0:
        ...
        tkinter.messagebox.showinfo("MEDICAL DATABSE SYSTEM", "PATIENT IS NOT ALLOCATED A ROOM")
...
def ROOMD_button():
    ...
    if (len(p)==0):
        tkinter.messagebox.showinfo("MEDICAL DATABASE SYSTEM","PATIENT NOT ALLOCATED ROOM")
    else:
...
def roomDD():
    ...
    rootRD.configure(bg='light coral')
    ra1=tkinter.Label(rootRD,text="ENTER PATIENT ID",fg='black',bg='light coral')
    ra1.place(x=20,y=20)
...
def Room_all():
    ...
    rootR.configure(bg='light coral')
    r_head=tkinter.Label(rootR,text="ROOM ALLOCATION",font='Times 25 bold',fg="steelblue",bg='light coral')
    r_head.place(x=75,y=10)
    id=tkinter.Label(rootR,text="PATIENT ID",fg='black',bg='light coral')
    id.place(x=30,y=60)
    P_id=tkinter.Entry(rootR)
    P_id.place(x=130,y=60)
    room_tl=tkinter.Label(rootR,text="ROOM TYPE",fg='black',bg='light coral')
    ...
    room_t.place(x=130,y=100)
    room_nol=tkinter.Label(rootR,text="ROOM NUMBER",fg='black',bg='light coral')
    ...
    room_no.place(x=140,y=180)
    ratel=tkinter.Label(rootR, text="ROOM CHARGES",fg='black',bg='light coral')
    ratel.place(x=30, y=220)
    rate=tkinter.Entry(rootR)
    rate.place(x=145, y=220)
    da_l = tkinter.Label(rootR, text="DATE ADMITTED",fg='black',bg='light coral')
    da_l.place(x=30,y=260)
    da=tkinter.Entry(rootR)
    da.place(x=145,y=260)
    dd_l = tkinter.Label(rootR, text="DATE DISCHARGED",fg='black',bg='light coral')
