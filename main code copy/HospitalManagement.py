...
db = mysql.connector.connect(user = 'root',password = 'Hruday@000',host='localhost',database = 'hospital')
c = db.cursor()
...
class LoginPage(tk.Frame):
    def __init__(self,master):
            ...
            self.heading = tk.Label(self, text="Hospital Supervision Portal",height = 5, font=('arial 40 bold'), fg='black', bg='steelblue').pack()
            self.email = tk.Label(self, text="Email Id", font=('arial 18 bold'), fg='white', bg='yellow').pack()
            self.email_ent = tk.Entry(self,fg='white', width=30)
            self.email_ent.pack()
